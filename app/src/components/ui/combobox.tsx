...
/* import { Button } from "@/components/ui/button" */ // Button not directly used in the provided snippet except in render props
import {
    InputGroup,
    InputGroupAddon,
    InputGroupButton,
    ...
    return (
        <InputGroup className={cn(className)}>
            ...
            <ComboboxPrimitive.Input
                ...
                className={cn(leftIcon && "pl-0", className)}
                {...props}
            />
...
function ComboboxList({ className, ...props }: ComboboxPrimitive.List.Props) {
    return (
        <ComboboxPrimitive.List
            ...
            className={cn(
                "no-scrollbar max-h-60 scroll-py-1 p-1 data-empty:p-0 overflow-y-auto overscroll-contain",
                className
            )}
            {...props}
        />
...
function ComboboxItem({
    ...
    label,
    ...props
}: React.ComponentProps<typeof ComboboxPrimitive.Item> & { label?: string }) {
    return (
