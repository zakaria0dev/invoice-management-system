...
export class CreditService {
     ...
     */
    static async applyCreditToInvoices(clientId: bigint, tx?: Prisma.TransactionClient, force: boolean = false, userId?: bigint) {
        const db = tx || prisma;
        ...
        try {
            ...
            for (const invoice of unpaidInvoices) {
                ...
                const nextStatus = calculateInvoiceStatus(fullInvoice as any);
                const metrics = calculateInvoiceMetrics(fullInvoice as any);
