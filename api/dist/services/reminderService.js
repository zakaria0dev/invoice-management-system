...
exports.processOverdueInvoices = exports.sendOverdueReminder = void 0;
 ...
 */
const sendOverdueReminder = async (invoiceId) => {
...
const processOverdueInvoices = async () => {
    ...
    const candidates = await prisma_1.default.invoice.findMany({
        where: {
    ...
    for (const inv of candidates) {
        ...
        if (isMilestone) {
            ...
            await (0, exports.sendOverdueReminder)(inv.id.toString());
        }
    }
};
exports.processOverdueInvoices = processOverdueInvoices;
